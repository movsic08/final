        ...
        // });
				...
				$(".colors").on("change",function(){
					...
					$(".colors").each(function(){
						...
						size_selected = 0;// reset the size

						/*Ajax for getting the size*/
							//update the sizes shown controller
							$.ajax({
								type : 'POST',
								url : "{{ route('front.get_product_size_details',) }}", //route to fetch the chat users
								data : { 
									id: id,
								...
								success: function(data){
									...
									$("#size_container").html(data.success);
									...
									$(".sizes").on("change",function(){
										...
										$(".sizes").each(function(){
											...
											/*Ajax for updating the total_stock*/
												$.ajax({
													type : 'POST',
													url : "{{ route('front.get_color_size_product_stock',) }}", //route to fetch the chat users
													data : { 
														id: id,
														color_selected: color_selected,
													...
													success: function(data){
														...
														$("#total_stock").html(data.total_stock + " Stocks");
											...
											/*end of Ajax for updating the total_stock*/
