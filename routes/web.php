...
/**user routes */
    ...
    //ajax to get product size details
    Route::post('/get_product_size_details',[ProductController::class,'get_product_size_details'])->name('front.get_product_size_details');
    //ajax to get product details
    Route::post('/get_color_size_product_stock',[ProductController::class,'get_color_size_product_stock'])->name('front.get_color_size_product_stock');
